...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Assosiate Software Engineer,Backend}{Nov 2023 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Recently awarded "DBS Tech Hero 2024" in the Most Versatile category, recognizing my adaptability and technical expertis}
            \resumeItem{Successfully managed UAT support across 8 Indonesian development squads, helping teams deliver high-quality solutions} 
            \resumeItem{Created and implemented robust pentest solutions that significantly improved our application security}
            \resumeItem{Maintained high standards in both functional and branch coverage, ensuring reliable code quality}
        \resumeItemListEnd
        \resumeSubheading
        {}{}
      {Assosiate Software Engineer,Frontend} {1.7 years(May 2022 \textbf{--} Nov 2023)}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Frontend Developer - Freelence}{2 years(Jan 2021 \textbf{--} Dec 2022)}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Frontend Developer}{2.8 years(March 2019 \textbf{--} Oct 2021)}
        \resumeItemListStart
    ...
    {Frontend Developer}{1,7 years(Sep 2017 \textbf{--} March 2019)}
        \resumeItemListStart
            \resumeItem{Demonstrated exceptional learning agility by rapidly mastering JavaScript and development frameworks from scratch, progressing to deliver valuable contributions within Rushowl of joining the company}
            \resumeItem{Build a MVP product for a transportation application using react-native for Singaporean}
        \resumeItemListEnd
