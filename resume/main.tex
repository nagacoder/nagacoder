...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Computer Science;   \textbf{GPA: 3.1/4.00}}{Jun 2021 \textbf{--} Aug 2024 (Expected)}
      { }{ }
        % \resumeItemListStart
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Assosiate Software Engineer,Frontend}{May 2022 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Maintaining internet banking for dbs Indonesia}
            \resumeItem{Build Feature and testing}
            \resumeItem{Improved performance}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Founder - Fullstack Developer}{Nov 2021 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Works with amazon EC2, s3 Bouquet and github actions to do CI-CD}
    ...
    \resumeSubheading
      ...
      {Frontend Developer}{March 2019 \textbf{--} Oct 2021}
        \resumeItemListStart
    ...
    {Frontend Developer}{Oct 2018 \textbf{--} March 2019}
        \resumeItemListStart
            \resumeItem{Build a MVP product for a transportation application using react-native.}
            \resumeItem{Implement google maps SDK and Real time application using socket io.}
        \resumeItemListEnd
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming:}{ C, C++, JavaScript, TypeScript} \\ \vspace{2pt}
        
        \textbf{Technologies:}{ Git, React, React Native, Jest, Chakra UI} \\ \vspace{2pt}
